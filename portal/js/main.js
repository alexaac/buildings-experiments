...
function animateTerrain(event) {
  if (isMobile) {
    ...
    parameters.mouse.x = touch.pageX;
    parameters.mouse.y = touch.pageY;
  } else {
    parameters.mouse.x = (event.clientX / sizes.width) * 2 - 0.5;
    parameters.mouse.y = 1.2 - (event.clientY / sizes.height) * 2;
  }
